...
// BUSCAR PERFIS (ISSO ESTAVA FALTANDO)
$perfis_query = "SELECT id, nome FROM perfil ORDER BY nome";
$perfis = mysqli_query($conexao, $perfis_query);
?>
                                ...
                                <select name="perfil_id" class="form-control" required>
                                    ...
                                    <?php while ($perfil = mysqli_fetch_assoc($perfis)) { ?>
                                        <option value="<?= $perfil['id']; ?>"
                                            <?= ($perfil['id'] == $usuario['perfil_id']) ? 'selected' : ''; ?>>
